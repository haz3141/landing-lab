export default function V3PaletteExploration() {
    return (
        <div className="min-h-screen bg-white text-zinc-800 font-sans antialiased selection:bg-indigo-100 selection:text-indigo-800">
            {/* Header */}
            <header className="fixed top-0 z-50 w-full border-b border-zinc-100 bg-white/90 backdrop-blur-md">
                <div className="mx-auto flex h-16 max-w-6xl items-center justify-between px-6">
                    ...
                    <nav className="hidden items-center gap-8 md:flex">
                        <a href="#how-it-works" className="text-sm text-zinc-500 transition-colors hover:text-indigo-700">How It Works</a>
                        <a href="#services" className="text-sm text-zinc-500 transition-colors hover:text-indigo-700">Services</a>
                        <a href="#reviews" className="text-sm text-zinc-500 transition-colors hover:text-indigo-700">Reviews</a>
                    </nav>
                    <a
                        href="#book"
                        className="group inline-flex h-9 items-center gap-2 rounded-full bg-indigo-600 px-5 text-sm font-medium text-white shadow-sm transition-all hover:bg-indigo-700 focus:outline-none focus-visible:ring-2 focus-visible:ring-indigo-500 focus-visible:ring-offset-2"
                    >
            ...
            <main>
                ...
                <section className="relative flex min-h-screen items-center justify-center overflow-hidden pt-16">
                    ...
                    <div className="pointer-events-none absolute inset-0 bg-gradient-to-b from-indigo-50/40 via-white to-white" />
                    ...
                    <div className="relative z-10 mx-auto max-w-4xl px-6 py-32 text-center">
                        ...
                        <h1 className="text-4xl font-bold tracking-tight text-zinc-900 sm:text-5xl lg:text-6xl">
                            ...
                            <span className="mt-2 block text-indigo-700">
                                Water Quality
                            </span>
                        </h1>
                        ...
                        <div className="mt-10 flex flex-col items-center justify-center gap-4 sm:flex-row sm:gap-6">
                            ...
                            <a
                                href="#how-it-works"
                                className="inline-flex h-12 items-center gap-2 text-base font-medium text-zinc-700 transition-colors hover:text-indigo-700"
                            >
                                See How It Works
                    ...
                    <div className="mx-auto max-w-6xl px-6">
                        ...
                        <div className="mt-16 grid gap-8 sm:grid-cols-3">
                            {[
                                ...
                                <div key={item.step} className="group relative rounded-2xl border border-zinc-200 bg-white p-8 shadow-sm transition-all hover:border-indigo-200 hover:shadow-md">
                                    <span className="mb-4 inline-block text-3xl font-bold text-indigo-600">
                                        {item.step}
                                    </span>
                    ...
                    <div className="mx-auto max-w-6xl px-6">
                        ...
                        <div className="mt-16 grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
                            {[
                                ...
                                <div
                                    key={service.name}
                                    className="group flex flex-col rounded-2xl border border-zinc-200 bg-white p-6 shadow-sm transition-all hover:border-indigo-200 hover:shadow-md"
                                >
                ...
                {/* Final CTA */}
                <section id="book" className="border-t border-zinc-100 bg-indigo-50 py-24 sm:py-32">
                    <div className="mx-auto max-w-3xl px-6 text-center">
                        ...
                        <div className="mt-10">
                            <a
                                href="#"
                                className="group inline-flex h-14 items-center justify-center gap-3 rounded-full bg-indigo-600 px-10 text-lg font-semibold text-white shadow-md transition-all hover:bg-indigo-700 hover:shadow-lg focus:outline-none focus-visible:ring-2 focus-visible:ring-indigo-500 focus-visible:ring-offset-2 focus-visible:ring-offset-indigo-50"
                            >
                ...
                <div className="mx-auto max-w-6xl px-6">
                    <div className="flex flex-col items-center justify-between gap-6 md:flex-row">
                        ...
                        <div className="flex gap-6">
                            <a href="#" className="text-sm text-zinc-500 transition-colors hover:text-indigo-700">Privacy</a>
                            <a href="#" className="text-sm text-zinc-500 transition-colors hover:text-indigo-700">Terms</a>
                        </div>
                    </div>
                </div>
            </footer>
